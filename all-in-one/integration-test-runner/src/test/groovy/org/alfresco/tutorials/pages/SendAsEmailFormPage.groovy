...
/**
 * TODO: fix this, so it really checks that it is a form
 *
 * Send-As-Email Form Page Object
 *
 * @author marting.bergljung@alfresco.com
 */
class SendAsEmailFormPage extends Page {
    // The relative URL of the page;
    // used by the to() method to determine which URL to send the HTTP request to.
    static url = "page/xxxxxxxxxxxxxxxxx"   // Not sure what this should be for popup form....,.....
